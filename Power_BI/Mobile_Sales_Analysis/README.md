...
### 🔹 Main Dashboard
![Mobile_Sales_Analysis](Images/Dashboard.png)

### 🔹 Filter Interaction View
![Mobile_Sales_Analysis](Images/Month_Wise_Filter.png)

### 🔹 Dropdown Slicer Interaction View
This view enables dynamic filtering using dropdown slicers for City, Brand, Payment Method, Mobile Model, and Weekday to analyze data interactively.

![Mobile_Sales_Analysis](Images/Dropdown_Slicer.png)

### 🔹 Measure and Columns Interaction View
This panel highlights organized Measures and Columns, helping distinguish calculated metrics and raw data fields for better analysis.

![Mobile_Sales_Analysis](Images/Measures_and_Column.png)
